...
`plans/archive/**` SHALL denote shipped/closed plans and SHALL be excluded from the gather's live
list; top-level `plans/*.md` SHALL be treated as live and listed.
