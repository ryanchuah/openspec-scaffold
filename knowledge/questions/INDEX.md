...
- clarify-audit-tooling propagation follow-on — RESOLVED/mechanized: lint-knowledge tombstone now in `scaffold_manifest_removed.txt` (auto-deletes on sync); applied to extrends 2026-07-04; psc-monitor auto-handled on its (frozen) next sync → `knowledge/questions/clarify-audit-tooling-propagation.md`
