...
## Latest change — knowledge-lint SHIPPED (2026-07-02)
...
## Prior change — deterministic-tooling-layer SHIPPED (2026-07-02)
...
Separately, `deterministic-tooling-layer` (MEDIUM, 2026-07-02) and `knowledge-lint` (2026-07-02) are
both complete but their downstream propagation is **explicitly frozen pending operator go-ahead**
