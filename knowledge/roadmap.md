...
OW-7 (`delegation-wrapper-telemetry`) SHIPPED 2026-07-13; OW-10 (`apply-throughput-resume`) SHIPPED 2026-07-14; OW-11 (`skill-debloat-gates`, mechanized half) SHIPPED 2026-07-14 (de-bloat half → OW-11-residual follow-on); OW-8, OW-12, OW-13 — still open (order OW-8 → OW-13 → OW-12).
