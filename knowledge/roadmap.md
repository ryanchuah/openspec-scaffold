...
OW-7 (`delegation-wrapper-telemetry`) SHIPPED 2026-07-13 (`openspec/changes/archive/2026-07-13-delegation-wrapper-telemetry/`); OW-8, OW-10, OW-11, OW-12, OW-13 — still open (order OW-10 → OW-11 → OW-8 → OW-13 → OW-12).
