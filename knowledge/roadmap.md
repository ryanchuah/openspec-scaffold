...
**Update 2026-07-13:** OW-2 (`lesson-check-ratchet`) and OW-3 (`verify-stack-redirect`) are **SHIPPED** (`openspec/changes/archive/2026-07-13-lesson-check-ratchet/`, `openspec/changes/archive/2026-07-13-verify-stack-redirect/`) — OW-3 delivered the "redirect the third pass to a lens" token move this backlog names. The frozen batch OW-2 → OW-3 → OW-5 → OW-6 is now **SHIPPED and archived** (2026-07-13), delivering four of this entry's six items (the ratchet, the verify-lens redirect, and the two audit skills); **OW-1 and OW-4 have now also SHIPPED** (2026-07-13, `defect-prevention-detectors` → `openspec/changes/archive/2026-07-13-defect-prevention-detectors/`) — **all six items (OW-1..6) are delivered; this entry is fully reconciled and closeable.** OW-7–14 (wave-2) plus the late OW-15/OW-16 are tracked in `knowledge/STATUS.md` Immediate next action.

## Correctness-audit meta-hardening (OW-15) — 2026-07-11
**Priority:** Medium
**Gating condition:** OW-5 (`correctness-audit-skill`) must apply first — OW-15 amends the capability it creates. (OW-5 **SHIPPED** 2026-07-13 — gate now clear; OW-15 is actionable.)
...
**Dependencies / notes:** Evidence + genericized 45-dimension taxonomy: `knowledge/research/scaffold-gap-analysis-2026-07/psc-coverage-gap-review-2026-07-11.md`; OW-15 entry in `OUTSTANDING-WORK.md` same dir; pointer left in `openspec/changes/archive/2026-07-13-correctness-audit-skill/notes.md` (freeze not reopened).
...
**Update 2026-07-14: OW-15 SHIPPED** (`openspec/changes/archive/2026-07-14-correctness-audit-meta-hardening/`) — all four deltas landed (liveness + wave-namespace separation, blind coverage-gap review, scope-seeding checklist with classes 9–12 as awareness pointers only, post-close ledger) plus the two guarded `knowledge_lint` detectors; this entry is closeable. Decisions: `knowledge/decisions/INDEX.md`; follow-ons: `knowledge/questions/correctness-audit-meta-hardening-follow-ons.md`.
...
**Update 2026-07-13:** OW-9 and OW-14 are **SHIPPED** (`instruction-surface-coherence` →
