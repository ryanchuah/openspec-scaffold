...
**Update 2026-07-13:** OW-2 (`lesson-check-ratchet`) is **SHIPPED** (`openspec/changes/archive/2026-07-13-lesson-check-ratchet/`). Remaining frozen batch OW-3 → OW-5 → OW-6 applies in that hard order (see `knowledge/STATUS.md` Immediate next action); this backlog entry is reconciled/closed when that batch fully archives. OW-1/OW-4/OW-7–14 remain un-proposed.
